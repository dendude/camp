...
class CampsQuery extends ActiveQuery
{
    ...
    {
        return $this->joinWith('contract')
                    ->andWhere(['camp_camps_contract.opt_gos_compensation' => Statuses::STATUS_ACTIVE]);
    }
    ...
    {
        return $this->joinWith('media')
                    ->andWhere(['is_main' => Statuses::STATUS_ACTIVE])
